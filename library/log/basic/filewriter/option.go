...
// ChanSize set basic chan size default 8192 use about 64k memory on x64 platfrom static,
// because filewriter has basic object pool, change chan size bigger may cause filewriter use
